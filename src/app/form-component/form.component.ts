...
export class FormComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,private data: DataService, private el: ElementRef, private router: Router, private transfer: TransferService) {
  ...
  onSubmitUserDetails(value){
    ...
    this.transfer.changeMessage(value);

    //Routing to account details form
