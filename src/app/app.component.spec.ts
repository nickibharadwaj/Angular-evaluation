...
describe('FormComponent', () => {
  ...
  it('gender should have 3 values', () => {
    const fixture = TestBed.createComponent(FormComponent);
    let el = fixture.debugElement.query(By.css('mat-radio-group'));
    let length = el.childNodes.length;
    expect(length).toBe(3);
  });

  it('button name should be submit', () => {
    const fixture = TestBed.createComponent(FormComponent);
    let el = fixture.debugElement.query(By.css('.submit-btn'));
    let buttonName = el.nativeElement;
    expect(buttonName.innerText).toBe('Submit');
  });
